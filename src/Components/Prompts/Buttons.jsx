        ...
        <>
            <div className="flex justify-center  ">
                <div className=" flex justify-between w-[600px] items-center  ">
                    ...
                    <button className="bg-white rounded-[40px] py-[17px] justify-center border  w-[146px] hover:border hover:border-[#1765FC] transition-all duration-300  text-[#1765FC] text-base font-medium flex gap-[10px] items-center "> {!active &&<img src={plus} alt="" />} {active ? "FINISH" : "Add more"}</button>
                </div>
            </div>
